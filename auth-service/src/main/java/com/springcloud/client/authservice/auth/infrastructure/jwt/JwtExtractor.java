...
import static com.springcloud.client.authservice.auth.exception.AuthExceptionType.ALREADY_EXPIRED_TOKEN;
import static com.springcloud.client.authservice.auth.exception.AuthExceptionType.INVALID_TOKEN;
import static com.springcloud.client.authservice.auth.exception.AuthExceptionType.INVALID_TOKEN_TYPE;

import com.springcloud.client.authservice.auth.application.TokenExtractor;
